          ...
          <div className="bg-[#FFFFFF] border border-pink-500/10 rounded-[24px] p-6 shadow-lg relative overflow-hidden group hover:border-pink-500/30 transition-colors">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#FFFFFF] border border-pink-500/10 flex items-center justify-center shrink-0 text-primary">
                  <Mail size={18} />
                </div>
                <div>
              ...
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#FFFFFF] border border-blue-500/10 flex items-center justify-center shrink-0 text-blue-400">
                  <FaTelegram size={18} />
                </div>
                <div>
              ...
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#FFFFFF] border border-gray-600/30 flex items-center justify-center shrink-0 text-gray-600">
                  <MapPin size={18} />
                </div>
                <div>
