  ...
  try {
    ...
    return (
      <div className="w-full px-3 md:px-4 mt-6 relative max-w-7xl md:mx-auto">
        <GlowBorder borderRadius={9999} className="w-full rounded-full bg-pink-50/80">
          <div className="w-full rounded-[inherit] bg-white/60 border border-pink-500/20 backdrop-blur-md flex items-center overflow-hidden">
            <div className="z-10 flex items-center gap-2">
              <div className="bg-primary rounded-full px-3 py-2 flex items-center gap-2 whitespace-nowrap shadow-sm">
            ...
            <div className="flex-1 overflow-hidden bg-transparent relative">
              <div className="animate-marquee flex w-max whitespace-nowrap">
                <span className="text-gray-800 text-sm font-medium pl-4 pr-12">
                  {announcementText}
                </span>
                <span
                  className="text-gray-800 text-sm font-medium pl-4 pr-12"
                  aria-hidden="true"
                >
                  {announcementText}
                </span>
