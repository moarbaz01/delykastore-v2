      ...
      <div className="mt-4 flex flex-col gap-2.5">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl text-gray-900 placeholder:text-gray-500 text-sm py-2.5 px-4 transition-all duration-200 focus:outline-none disabled:opacity-50"
            style={{
              background: "#FDFDFD",
          ...
          {appliedCoupon ? (
            <button
              ...
              className="px-4 py-2 rounded-xl text-red-500 text-sm font-medium transition-all duration-200 hover:bg-red-500/10"
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-white text-sm font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-[0_0_15px_rgba(255,117,151,0.3)]"
        ...
        {couponError && (
          <p className="text-red-500 text-xs px-1">{couponError}</p>
        )}
